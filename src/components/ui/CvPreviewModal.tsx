    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="relative w-full max-w-4xl h-[85vh] bg-surface border border-border-gold rounded-2xl overflow-hidden flex flex-col max-sm:max-w-full max-sm:h-[95vh] max-sm:rounded-lg"
        >
