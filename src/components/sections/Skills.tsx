  ...
  return (
    <motion.div variants={container} initial="hidden" animate="show" className="flex flex-col gap-10">
      <motion.div variants={anim}>
        <h3 className="text-lg sm:text-xl text-heading font-semibold mb-4">Currently</h3>
      ...
      <motion.div variants={anim}>
        <h3 className="text-lg sm:text-xl text-heading font-semibold mb-5">Experience</h3>
      ...
      <motion.div variants={anim}>
        <h3 className="text-lg sm:text-xl text-heading font-semibold mb-5">Education</h3>
        <div className="flex flex-col gap-5">
